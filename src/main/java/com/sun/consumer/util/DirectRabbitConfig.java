...
public class DirectRabbitConfig {
    ...
    @Bean
    DirectExchange TestDirectExchange3() {
        return new DirectExchange("testProduct",true,false);
    }
    ...
    Binding bindingDirect3() {
        return BindingBuilder.bind(TestDirectQueue3()).to(TestDirectExchange3()).with("testKey");
    }
